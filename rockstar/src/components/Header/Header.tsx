        ...
        <header className={`fixed z-50 top-0 ${background ? "bg-black" : "bg-transparent"} w-full pt-5 pb-5 pl-[6%] pr-[6%] bg-black flex items-center justify-between`}>
            ...
            <div className='flex items-center justify-between gap-12'>
                ...
                <ul className='md:flex hidden flex-wrap gap-6'>
                    <Link to={"/jogos"}><li className='cursor-pointer text-white flex'>Jogos <img src={arrowDown} alt='arrowDown'/> </li> </Link>
                    <Link to={"/loja"}><li className='cursor-pointer text-white flex'>Loja </li> </Link>
                    <Link to={"/ajuda"}><li className='cursor-pointer text-white flex'>Ajuda </li> </Link>
                </ul>
            </div>

            <div className='flex relative items-center justify-between gap-6'>
                <Link to={"/launcher"}><button className='bg-[#FCAF17] pr-5 pl-5 pb-3 pt-3 text-black rounded-xl'>Baixe o Launcher</button></Link>
